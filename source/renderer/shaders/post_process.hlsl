...
{
    Texture2D<float4> color_in = ResourceDescriptorHeap[NonUniformResourceIndex(g_input.color_index)];
    RWTexture2D<float4> rt = ResourceDescriptorHeap[NonUniformResourceIndex(g_input.rt_index)];
